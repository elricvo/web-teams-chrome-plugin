...
> Statut global : **V1.0 — capture visible, collecte progressive contrôlée, exports JSON/Markdown et bundle Markdown+images implémentés ; qualification Teams interactive à terminer.**
...
- [x] T006 Définir la stratégie de scroll et de virtualisation ; l’ouverture automatique des fils reste hors périmètre.
...
- [x] T013 Implémenter collecte progressive, arrêt et détection de changement d’espace. *(Qualification interactive Chrome à réaliser.)*
...
- [ ] T020 Réaliser une revue sécurité/confidentialité finale et qualifier V1.0 dans un navigateur réel.
